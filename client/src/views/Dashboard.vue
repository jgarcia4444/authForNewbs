...
<section>
    ...
    <form @submit.prevent="addNote()" v-if="showForm">
        <div class="form-group">
            ...
            <input v-model="newNote.title" type="text" id="title" class="form-control" aria-describedby="titleHelp" placeholder="Enter a Title" required/>
            <small id="titleHelp" class="form-text text-muted">Enter a descriptive title for your note.</small>
        </div>
        <div class="form-group">
            <label for="note">Note</label>
            <textarea v-model="newNote.note" class="form-control" id="note" rows="3" placeholder="Enter your note" required></textarea>
        </div>
